(function () {
    ...
    var fa = function (a, b) {
        ...
        ma = function (a) {
            if (!ga.test(a)) return a; - 1 != a.indexOf("&") && (a = a.replace(ha, "&amp;")); - 1 != a.indexOf("<") 1="" &&="" (a="a.replace(ia," "&lt;"));="" -="" !="a.indexOf("">") && (a = a.replace(ka, "&gt;")); - 1 != a.indexOf('"') && (a = a.replace(la, "&quot;"));
            return a
        },
        ha = /&/g,
        ia = //g,
    ...
    var Fa = Aa,
        ...
        Ha = function (a) {
            ...
            if (!(b = Ga[a])) {
                ...
                b = Ga[a] = 0 <= b="" }="" return="" },="" ia="{}," j="function" (a)="" {="" ia[a]="" ||="" (ia[a]="E" &&="" document.documentmode="">= a)
        };
    var Ja, Ka = !E || J(9);
    ...
    var La = function (a, b) {
            ...
            var d = ra(arguments, 1),
                f;
            f = c;
            for (var e = 0, h = 0; h < d.length; h++) 0 <= 0="=" 9="=" na(f,="" d[h])="" ||="" (f.push(d[h]),="" e++);="" f="e" =="d.length;" a.classname="c.join("" ");="" return="" };="" var="" ma="function" (a)="" {="" a="" ?="" new="" k(l(a))="" :="" ja="" (ja="new" k)="" },="" na="function" (a,="" b)="" c="b" &&="" "*"="" !="b" b.touppercase()="" "";="" a.queryselectorall="" a.queryselector="" (!g="" "css1compat"="=" document.compatmode="" ha("528"))="" a.queryselectorall(c="" +="" "")="" a.getelementsbytagname(c="" "*")="" pa="function" sa(b,="" function="" (b,="" d)="" "style"="=" d="" a.style.csstext="b" "class"="=" "for"="=" a.htmlfor="b" in="" oa="" a.setattribute(oa[d],="" d.lastindexof("aria-",="" 0)="" a.setattribute(d,="" a[d]="b" })="" cellpadding:="" "cellpadding",="" cellspacing:="" "cellspacing",="" colspan:="" "colspan",="" rowspan:="" "rowspan",="" valign:="" "valign",="" height:="" "height",="" width:="" "width",="" usemap:="" "usemap",="" frameborder:="" "frameborder",="" maxlength:="" "maxlength",="" type:="" "type"="" qa="function" b,="" c)="" d(c)="" b.appendchild(u(c)="" a.createtextnode(c)="" }="" for="" (var="" <="" c.length;="" f++)="" e="c[f];" if="" (aa(e)="" !(ba(e)="" e.nodetype))="" h;="" a:="" (e="" "number"="=" typeof="" e.length)="" (ba(e))="" h="function" e.item="" "string"="=" e.item;="" break="" ("function"="=" r(e))="" oa(h="" qa(e)="" e,="" else="" d(e)="" l="function" a.nodetype="" a.ownerdocument="" a.document="" k="function" this.c="a" q.document="" document="" k.prototype.za="function" (!ka="" (h.name="" h.type))="" e];="" h.name="" e.push('="" name="', ma(h.name), '" ');="" (h.type)="" type="', ma(h.type), '" n="{};" ua(n,="" h);="" delete="" h.type="" e.push("="">");
            e = e.join("")
        }
        e = d.createElement(e);
    ...
    var Ya = function (a, b, c, d) {
        ...
        $a = function (a, b, c) {
            for (var d = 0, f = c - 1; f <= 9="" 88="" 200="" 5808="" c="" +="" 1;="" f++)="" for="" (var="" e="b" -="" <="b" e++)="" var="" h="a," n="e," j="f," math.min(87,="" n)),="" math.min(65,="" j)),="" d="d" h.w[j][n];="" return="" },="" ab="function" (a,="" b)="" {="" a.$="k;" b.fillstyle="rgba(240,246,246,0.8)" ;="" b.fillrect(0,="" 0,="" b.canvas.width,="" b.canvas.height)="" };="" ya.prototype.s="function" (a)="" if="" (!(this.$="" ||="" this.ga="" this.s))="" a.fillstyle="rgba(240,246,246,0.08)" b="0;"> b; b++) {
        ...
        mb = function (a) {
            ...
            if (a.Z) {
                ...
                if (!(580.8 > b.S) && !(b.$ || 88 < b.ga)) {
                    for (var c = b.S = 0, d = 0; 66 > d; d++) for (var f = 0; 88 > f; f++) b.w[d][f] += b.G[d][f], 3.5 <= b.w[d][f]="" &&="" c++;="" b.ga++;="" if="" (c="">= 70.4 * 66) b.$ = k;
